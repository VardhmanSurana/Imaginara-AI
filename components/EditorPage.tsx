...
export type EditorMode = 'edit' | 'remove' | 'replace_bg' | 'enhance' | 'style_transfer' | 'resize' | 'transform' | 'change_ratio';
...
            transform: { hasMasking: false }, change_ratio: { hasMasking: false },
...
        // Draw original image onto the new canvas at the correct offset
...
    }, [handleUndo, handleRedo, editorMode, handleCancelResize, handleConfirmResize, handleCancelTransform, handleCancelAspectRatio, handleApplyAspectRatioCanvas]);
...
                case 'change_ratio': // No generate action for change_ratio mode
